...
if __name__ == "__main__":
	...
	try:
		...
		if(len(SelData) == 1):
			...
			plt.bar(x=ticks, height=height, width=WIDTH)
			plt.set_xticks(ticks + WIDTH/2, ticks)
			...
			plt.set_xticks(Levels+WIDTH, LevLbls if HasLevLbls else Levels+1)
		...
		Framework().messagebox(str(e), "Column Error!")